...
[![Latest Release](https://img.shields.io/github/v/release/GarthTB/keytao-dict-checker?color=0FBF3E&label=Latest&logo=github)](https://github.com/GarthTB/keytao-dict-checker/releases/latest)
...
1. 从 [Latest Release](https://github.com/GarthTB/keytao-dict-checker/releases/latest) 下载相应平台的压缩包并解压
2. 在 `config.toml` 中配置参数
3. 运行 `cn-input-encode <config.toml>`，问题报告将输出至词库所在目录，默认为 `{原名}-report.txt`，若已存在则自动加编号，不会覆写

## ℹ 关于

- 地址：https://github.com/GarthTB/keytao-dict-checker
